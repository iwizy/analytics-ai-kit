...
- генерировать выбранный комплект документов, а не только FT/NFT,
...
4. выбрать документы для генерации галками или пресетом
5. сгенерировать выбранный комплект документов
6. при необходимости запустить `Gaps`, `Refine` и подготовить `handoff`
...
Основной сценарий генерации теперь работает через выбор документов.
...
- [docs/templates/catalog.yaml](/Users/iwizard/Dev/analytics-ai-kit/docs/templates/catalog.yaml)

Подробности:

- [docs/generation-targets.md](/Users/iwizard/Dev/analytics-ai-kit/docs/generation-targets.md)
